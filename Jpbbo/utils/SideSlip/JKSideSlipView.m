...
//
#define SLIP_WIDTH  [UIScreen mainScreen].bounds.size.width*4/5
...
- (instancetype)initWithSender:(UIViewController*)sender{
    ...
    if (SCREEN_HEIGHT>480) {
        frame = CGRectMake(-SLIP_WIDTH, 0, SLIP_WIDTH, bounds.size.height);
    }else{
        frame = CGRectMake(-SLIP_WIDTH, 0, SLIP_WIDTH, bounds.size.height*0.78);
    }
